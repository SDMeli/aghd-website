        ...
        <div className="bg-transparent backdrop-blur-sm border border-white/3 rounded-3xl px-6 py-8 md:px-8 md:py-10 max-w-lg w-full">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-white/90 font-amiri text-lg">تاریخ و ساعت</p>
              <p className="text-white/70 text-sm mt-1">۸ شهریور ۱۴۰۵، ساعت ۱۸:۰۰</p>
            </div>
            ...
            <div>
              ...
              <p className="text-white/90 font-amiri text-lg">مکان</p>
              <p className="text-white/70 text-sm mt-1">شیراز، هتل بوتیک آلان</p>
            </div>
          </div>
